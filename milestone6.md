...
Well, there are at least two entry points, where we need to find our ELF executable name and path + we need to find our readme.md. Some puzzle elements (patch from glibc 2.43): [some patch elements](doit/in/libc/243_patch1.txt)
