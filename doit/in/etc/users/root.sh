...
cd /
export PATH=/app/kbd/current:/app/nftables/current:/app/dinit/current/:/app/util-linux/current:/app/mc/current:/app/busybox/current/bin:/app/busybox/current/sbin
