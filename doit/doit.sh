...
package="less"; # "fs" to build all or concrete name for concrete package (busybox, nftables, etc.) or iso to build iso file
...
#    download_unpack_source https://github.com/gwsw/less/archive/refs/tags/v$ver.tar.gz less less-$ver 1
    ...
    autoconf
    ./configure --prefix=$output/app/less/$prefix$ver
    make all -j$cpu_num
